...
d1=Doctor.create(name: "Erin Bolivar", location_id: l1.id, phone_number: "713-111-1111", specialty_id: s5.id)
d2=Doctor.create(name: "Daniel Schatz", location_id: l2.id, phone_number: "713-123-2222", specialty_id: s2.id)
d3=Doctor.create(name: "Cassandra Wertz", location_id: l3.id, phone_number: "713-222-3333", specialty_id: s3.id)
d4=Doctor.create(name: "Alejandro Mora", location_id: l1.id, phone_number: "713-333-5555", specialty_id: s5.id)
d5=Doctor.create(name: "John Paulsel", location_id: l6.id, phone_number: "713-321-1155", specialty_id: s6.id)
